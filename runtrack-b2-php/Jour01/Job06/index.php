...
echo "<h1>Bonus</h1>";
// Fonction my_array_sort() pour trier un tableau dans l'ordre croissant ou décroissant, y compris les chaînes de caractères.
function my_array_sort_bonus(array $arrayToSort, string $order): array {
    $size = count($arrayToSort);
...
// Exemple d'utilisation de la fonction pour trier un tableau dans l'ordre croissant (numérique et alphabétique).
$arrayToSort = [5, 2, "apple", 9, 1, "banana", 5, "cherry", 6];
$sortedArrayAsc = my_array_sort_bonus($arrayToSort, "ASC");
echo "<h2>Tri dans l'ordre croissant :</h2>";
...
// Exemple d'utilisation de la fonction pour trier un tableau dans l'ordre décroissant (numérique et alphabétique).
$sortedArrayDesc = my_array_sort_bonus($arrayToSort, "DESC");
echo "<h2>Tri dans l'ordre décroissant :</h2>";
